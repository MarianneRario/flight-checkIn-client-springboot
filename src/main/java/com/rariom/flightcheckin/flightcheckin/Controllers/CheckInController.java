...
public class CheckInController {
    ...
    protected String startCheckIn(// @RequestParam value SHOULD be the same with the "name" in our html
        ...
        System.out.println("Departure Date: " + reservation.getFlight().getDepartureDate());
    ...
    protected String completeCheckIn(
        ...
        System.out.println("No. of Bags: " + numberOfBags);
        ReservationUpdateRequest request = new ReservationUpdateRequest();
        request.setId(reservationId);
        request.setLuggageQuantity(numberOfBags);
